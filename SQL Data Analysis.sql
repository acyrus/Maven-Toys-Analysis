...
-- Finding the daily total running sales and profit for each store and each product
SELECT 
...
-- Table creation to compare aggeegate values across days of the weeks and months of the year in PowerBI
